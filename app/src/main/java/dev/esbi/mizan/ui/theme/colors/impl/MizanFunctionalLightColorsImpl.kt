 ...
 */
@Immutable
internal class MizanFunctionalLightColorsImpl(
    primitiveColors: MizanPrimitiveColors
) : MizanFunctionalColors {

    override val bgPrimary = Color(0xFFF8F9FA)
    override val bgSecondary = Color(0xFFFFFFFF)
    override val bgTertiary = Color(0xFFF1F3F5)
    override val glassBackground = primitiveColors.white100.copy(alpha = 0.80f)
    override val glassBorder = primitiveColors.black100.copy(alpha = 0.08f)
    override val textPrimary = Color(0xFF1A1A2E)
    override val textSecondary = Color(0xFF4A5568)
    override val textTertiary = Color(0xFF718096)
    override val textMuted = Color(0xFFA0AEC0)
    override val surface1 = primitiveColors.black100.copy(alpha = 0.02f)
    override val surface2 = primitiveColors.black100.copy(alpha = 0.04f)
    override val surface3 = primitiveColors.black100.copy(alpha = 0.08f)
    override val surface4 = primitiveColors.black100.copy(alpha = 0.12f)
    override val shadowSM = primitiveColors.black100.copy(alpha = 0.06f)
    override val shadowMD = primitiveColors.black100.copy(alpha = 0.08f)
    override val shadowLG = primitiveColors.black100.copy(alpha = 0.12f)
    override val shadowXL = primitiveColors.black100.copy(alpha = 0.16f)
    override val glowPrimary = Color(0xFF667EEA).copy(alpha = 0.30f)
    override val glowSecondary = Color(0xFFF5576C).copy(alpha = 0.30f)
    override val glowSuccess = Color(0xFF00F2FE).copy(alpha = 0.30f)
