 ...
 */
@Immutable
internal class MizanSemanticOverlayColorsImpl(
    functionalColors: MizanFunctionalColors,
    primitiveColors: MizanPrimitiveColors,
) : MizanSemanticColors {
    override val systemBg: Color = functionalColors.bgPrimary
//    override val sectionHintText = functionalColors.textSecondary
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as MizanSemanticOverlayColorsImpl
...
//        result = 31 * result + sectionHintText.hashCode()
    ...
    override fun toString(): String {
        return "MizanSemanticOverlayColorsImpl(" +
                "systemBg=$systemBg, " +
