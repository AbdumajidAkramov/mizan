...
fun PremiumEmergencyFund(
    ...
    PremiumCard(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.financial_mirror_emergency_fund),
            ...
            Row(
                ...
                Box(
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        Text(
                            text = stringResource(R.string.financial_mirror_funded),
                ...
                Column(modifier = Modifier.weight(1f)) {
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text(
                                text = stringResource(R.string.financial_mirror_current),
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text(
                                text = stringResource(R.string.financial_mirror_goal),
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.onSurfaceVariant
                            )
                            Text(
                    ...
                    Text(
                        text = stringResource(R.string.financial_mirror_target_months, targetMonths),
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
