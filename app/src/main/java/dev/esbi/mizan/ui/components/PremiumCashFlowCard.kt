...
fun PremiumCashFlowCard(
    ...
    PremiumCard(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.financial_mirror_cash_flow),
            ...
            Canvas(
                ...
                val incomeHeight = if (maxValue > 0) (income / maxValue * size.height * 0.8f).toFloat() else 0f
                val expensesHeight = if (maxValue > 0) (expenses / maxValue * size.height * 0.8f).toFloat() else 0f
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.financial_mirror_net_cash_flow),
